    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-white mt-10 mb-40">
            ...
            <div className="bg-[#333] text-white p-8 rounded-lg shadow-md w-full max-w-md border border-gray-400 ">
                <h2 className="text-xl font-bold mb-1">Registrarse</h2>
                <p className="text-sm mb-6 text-gray-300">Para registrarse diligencia los siguientes datos</p>
                ...
                <p className="text-center text-sm mt-6 text-gray-300">
                    ¿Ya tienes cuenta?{' '}
                    <a href='/login' className="text-white font-semibold hover:underline cursor-pointer">
                        iniciar sesión
                    </a>
                </p>
            </div>
